...
public class EduRxVolley {
    ...
    private static final String CSMY_BASE_URL_XH = "http://jw3.csmzxy.com:8088/xs_main.aspx?xh=";
    ...
    private static final String LOGIN_VIEWSTATE_VALUE = "dDw3OTkxMjIwNTU7Oz4BO%2FY3htAyQJF%2FNwKj5qZqDUYy9g%3D%3D";
    private static final String LOGIN_VIEWSTATEGENERATOR = "__VIEWSTATEGENERATOR";
    private static final String LOGIN_SCHEDULE_VIEWSTATEGENERATOR_VALUE = "92719903";
        ...
        new RxVolley.Builder()
                ...
                .callback(new HttpCallback() {
                    ...
                    public void onFailure(int errorNo, String strMsg) {
                        ...
                        Logger.d("进入教务系统主页失败");
                        DataCleanManager.cleanInternalCache(LitePalApplication.getContext());
    ...
    public static void loignEducation() {
        ...
        params.put(LOGIN_TEXT_BOX_THREE, EMPTY);
        params.put(LOGIN_RADIO_BUTTON_LIST, LOGIN_RADIO_BUTTON_LIST_VALUE);
        params.put(BUTTON_ONE, EMPTY);
